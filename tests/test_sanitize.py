...
class TestSanitizeParsedArgsForLog:
    def _make_parsed(self, **kwargs):
        ...
        parsed.allow_private_urls = kwargs.get("allow_private_urls", False)
        parsed.headers = kwargs.get("headers", {})
        auth = MagicMock()
        auth.bearer = kwargs.get("bearer", None)
        auth.basic = kwargs.get("basic", None)
        auth.api_key = kwargs.get("api_key", None)
        auth.api_key_header = kwargs.get("api_key_header", None)
        parsed.auth = auth
        mtls = MagicMock()
